...
interface NamespaceColorPickerProps {
  /** Current color value */
...
/**
 * Color picker for namespace visual organization
 * Uses fixed positioning to render above all content
 */
export function NamespaceColorPicker({
  value,
  onChange,
  disabled = false,
}: NamespaceColorPickerProps): React.ReactElement {
